...
const promotionSlides = ref([
  {
    title: '智能自动化解决方案',
    description: '我们的智能自动化平台能够高效处理日常工作中的重复性任务，从数据采集、智能分析到精准执行，为您提供一站式解决方案。无需复杂配置，简单几步即可启动自动化流程，让您专注于更具价值的战略性工作。',
    image: require('@/assets/images/product-features.svg')
  },
  {
    title: '前沿AI智能技术',
    description: '我们不仅提供基础自动化功能，更融合了先进的机器学习算法，持续优化您的工作流程。系统能够智能学习您的使用习惯和反馈，自动调整执行策略，实现越用越智能的个性化体验。这种自适应技术使我们的解决方案在行业中保持领先地位。',
    image: require('@/assets/images/ai-innovation.svg')
  },
  {
    title: '卓越成就与认可',
    description: '目前已有超过5000家知名企业选择我们的服务，月处理任务量突破100万次。客户数据表明，使用我们的解决方案后，工作效率平均提升85%，客户满意度高达98%。这些成果体现了我们对产品质量的执着追求和对客户需求的深刻理解。',
    image: require('@/assets/images/achievements.svg')
  },
  {
    title: '选择我们的理由',
    description: '我们的核心团队由行业资深专家组成，不仅精通技术，更深入理解您的业务挑战。我们提供量身定制的解决方案，而非通用型产品。数据安全是我们的首要原则，所有信息均采用高级加密技术保护。最重要的是，我们持续创新，不断根据用户反馈优化产品体验。',
    image: require('@/assets/images/why-choose-us.svg')
  },
  {
    title: '全方位技术支持',
    description: '遇到技术难题？我们提供多渠道专业支持。从详尽的使用文档到直观的视频教程，从7×24小时专属客服到活跃的用户社区，我们确保您总能获得最适合的帮助。我们的使命是消除任何可能阻碍您充分利用我们产品的技术障碍。',
